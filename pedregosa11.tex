...
\usepackage{jmlr2e}
\usepackage{url}
\jmlrheading{1}{2011}{XX}{3/11; Revised 8/11}{XXX}{Pedregosa, Varoquaux,
Gramfort, Michel, Thirion, Grisel, Blondel, Prettenhofer, Weiss, Dubourg,
Vanderplas, Passos, Cournapeau, Brucher, Perrot, Duchesnay}
...
\noindent\emph{Scikit-learn} provides a $\sim$300 page user guide including
...
\noindent\emph{Scikit-learn} exposes a wide variety of machine learning
