...
growing need of non-specialists for statistical data analysis in the software and web
...
\noindent{\bf Scipy}:
%
efficient algorithms for linear algebra, sparse matrix structure,
special functions and basic statistical functions. {\sl Scipy} has
binding for many Fortran-based standard numerical packages, such as 
LAPACK. This is important for ease of install and portability, as
providing binaries binding Fortran code can prove challenging on
various platforms.
...
%
Estimators may also provide a {\tt score} method, evaluating the
goodness of fit of an estimator. It may be a log-likelihood, or a
negated loss function, but must always increase with goodness of fit.
%
...
%
Future work include the addition of \emph{online} learning, to scale on
large datasets.
