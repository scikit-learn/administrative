...
\FABIAN{We perform training and prediction using MADELON, a 4400
  instances and 500 attributes dataset

 \GAEL{Fabian: please give details on the
  dataset.}. In the following, we discuss some aspects of these
results, to illustrate the engineer trade offs related to performance
in a high-level language. Note that, as of release 0.6, the
