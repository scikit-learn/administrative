...
only on numpy and scipy to facilitate distribution
(\url{http://numpy.scipy.org/}), unlike pymvpa
...
tests {\tt nose tests}: as of release 0.6, test coverage is 78\%. We follow the
Python
...
Moreover, many contributions are experiment-driven, thus providing robust and
easily usable algorithms.
...
%
The only other important object is the {\tt cross-validation iterator}:
