...
the engineering trade offs related to performance. Note that,
...
k-Nearest Neighbors & {\bf 1.82} & 4.26 & - &  {\bf 1.82} & $\star^2$ & 4.14 \\
PCA (9 components) & {\bf 0.42} & 3.01  & 2.94  & $\star^1$ & 0.58  & - \\
k-Means (9 clusters) & 2.64 & 0.66 & $\star$ & -  & 27.8 & {\bf 0.49} \\
...
$^2$: Runs out of memory on a 16Gb computer.
\vspace*{-1.5ex}
%\end{minipage}
\caption{\small
