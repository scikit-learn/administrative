...
Principal Component Analysis & {\bf 0.42} & 3.01  & 2.94  & * & 0.58  & - \\
k-Means  & 0.16 & {\bf 0.02} & 187.02  & 0.0  & 0.07 & 0.07 \\
...
* PyMVPA does not allow to set a specific number of components, thus
computations span during several minutes (> 20min).
