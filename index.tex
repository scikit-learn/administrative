...
coded efficiently using Numpy/Scipy while retaining some of the
...
However, we also incorporate some C/C++ libraries that are steadily
available, such as libsvm and liblinear. These libraries have been
carefully binded using Cython, and we have been capable of eliminating
most of the C/Python communication overhead from which most bindings
suffered. We also provide bindings that are both capable of working
with dense and sparse matrices, something not implemented in any other
Python library (AFAIK).
