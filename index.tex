...
A unified framework for model selection is tricky, as ideally the
problem should be solved for all models but in practice
method-specific considerations must be taken for efficiency.
