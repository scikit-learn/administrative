...
%% accesible for non-specialists: language, API, documentation
...
%% It's high level, general-purpose, interactive nature, it's openness
%% and the maturation of the scientific libraries (numpy, scipy) make
%% it a very appealing choice for both research and industry.
...
%% numerical efficiency is achieved 
